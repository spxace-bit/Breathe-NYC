...
/* ---------- VARIABLES & RESET ---------- */
:root{
  --bg: #000000cd;            /* Deep forest green background */
  --card: #252121;          /* Slightly lighter card green */
...
.header-inner{
  ...
  padding:45px 0; /* increased from 18px to 30px */
  gap:16px;
}
.brand{
  display:flex;
...
.tagline{
  margin:0;
  font-size:20px; /* increased from 12px to 16px */
  color:var(--muted);
}
/* NAV */
.site-nav{
